     ...
     >
             ...
             <div>
               ...
               <div class="col-12">
                 <div class="q-my-sm col-12">
                   ...
                   <q-input outlined v-model="user.email" color="dark" />
                 </div>
                 <div class="col-12 row">
                   <div class="q-my-sm col-6">
                     <div class="col-12 q-mr-xs">
                       <label>First name</label>
                       <q-input outlined v-model="user.firstName" color="dark" />
                     </div>
                   </div>
                   <div class="q-my-sm col-6">
                     <label>Last name</label>
                     <q-input outlined v-model="user.lastName" color="dark" />
                   </div>
                 </div>
                 <div class="q-my-sm col-12">
                   <label>Your address</label>
                   <q-input outlined v-model="user.address" color="dark" />
                 </div>
                 <div class="q-my-sm col-12">
                   <label>Your city/province</label>
                   <q-input outlined v-model="user.province" color="dark" />
                 </div>
                 <div class="q-my-sm col-12">
                   <label>Your phone number</label>
                   <q-input outlined v-model="user.phoneNumber" color="dark" />
                 </div>
                 <div class="q-my-sm col-12">
                   <label>Leave your note for us</label>
                   <q-input type="textarea" rows="3" outlined v-model="user.note" color="dark" />
                 </div>
               </div>
             </div>
           </div>
                 ...
                 <q-list bordered separator>
                   <q-item tag="label" class="q-py-lg" v-ripple>
                     <q-item-section side top>
                       <q-checkbox :disable="true" color="dark" v-model="payment.check1" />
                     </q-item-section>
                   ...
                   <q-item tag="label" class="q-py-lg"  v-ripple>
                     <q-item-section  side top>
                       <q-checkbox :disable=" true" color="dark" v-model="payment.check2" />
                     </q-item-section>
       ...
       <template v-slot:navigation>
         <q-stepper-navigation class="flex justify-end">
           <div>
             <q-btn color="green-9" v-if="step === 3" @click="Emitt" label="Finish" />
             <q-btn @click="$refs.stepper.next()" color="green-9" v-if="step !== 3" label="Continue" />
...
export default {
  ...
  mounted() {
    if (this.delivery.value === "Normal") {
      this.payment.check1 = true
      this.payment.check2 = false
    }
    else {
      this.payment.check2 = true
      this.payment.check1 = false
    }
